...
const Homepage = () => {
  // constant re rendering when detting product data
  ...
  const filtereddata=useFilterProducts(Productdata,'soccer');
console.log(filtereddata);
  return <div>
<Products Productdata={Productdata} />
    
    <button onClickCapture={()=>{setProductdata(filtereddata)}}>SOCCER ONLY</button>
